...
const GamingPC = () => {
    ...
    return (
        <Flex style={{ flexWrap: "wrap" }} direction="column" justifyContent="center" alignItems="center" margin="20px 0px 40px 0px" width="100%">
            ...
            <Flex style={{ border: "3px solid #e3e3e3" }} borderRadius="60px" backgroundColor={isDay ? DAY_BACKGROUND_COLOR_CONTAINER : NIGHT_BACKGROUND_COLOR_CONTAINER} direction="column" direction="column" justifyContent="center" alignItems="center" width="60px" height="60px">
